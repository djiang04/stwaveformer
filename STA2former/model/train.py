...
from STAWave2former.model.model import STAEformers
...
if __name__ == "__main__":
    ...
    parser.add_argument("-p", "--preprocess", type=str, default=0)
    ...
    model_name = STAEformers.__name__
    ...
    model = STAEformers(**cfg["model_args"])
    ...
    model = train(
        ...
        max_epochs=cfg.get("max_epochs", 18),
